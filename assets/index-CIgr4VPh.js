...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wa,depthTest:!1,depthWrite:!1})}function P_(){return new Za({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ap(),fragmentShader:`
		...
		`,blending:Wa,depthTest:!1,depthWrite:!1})}function z_(){return new Za({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ap(),fragmentShader:`
		...
		`,blending:Wa,depthTest:!1,depthWrite:!1})}function ap(){return`
...
#define LOW_PRECISION`),t}function Jb(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===iv?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===av?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===ua&&(t="SHADOWMAP_TYPE_VSM"),t}function $b(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Pr:case zr:t="ENVMAP_TYPE_CUBE";break;case eu:t="ENVMAP_TYPE_CUBE_UV";break}return t}function tA(o){let t="ENVMAP_MODE_REFLECTION";return o.envMap&&o.envMapMode===zr&&(t="ENVMAP_MODE_REFRACTION"),t}function eA(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case sv:t="ENVMAP_BLENDING_MULTIPLY";break;case Mx:t="ENVMAP_BLENDING_MIX";break;case Ex:t="ENVMAP_BLENDING_ADD";break}return t}function nA(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,s=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:s,maxMip:i}}function iA(o,t,i,s){const l=o.getContext(),c=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=Jb(i),p=$b(i),S=tA(i),_=eA(i),y=nA(i),M=Xb(i),T=Wb(c),A=l.createProgram();let x,g,P=i.glslVersion?"#version "+i.glslVersion+`
